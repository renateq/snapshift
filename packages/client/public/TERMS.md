...
- This Service **does not store or access the contents of any files** you share.
- The system records only **non-identifiable metadata**, such as the file size and timestamp, to monitor system usage and performance.
...
© 2025 Snapshift. All rights reserved.
